...
$orderId = $_GET["orderId"];
		...
		if ($resultcode != 0) {
			...
			$data= array();
            $data['data']['title'] = 'Validus Order Payment';
       ...
       //   header("location:https://denkiri.000webhostapp.com/sales/pages/cashier/preview.php?invoice=$orderId");
            //	exit();
	        ...
	        for($i = 0; $i < count($mpesacode); ++$i) {
		     ...
		     $cdb->updateOrderPaid($orderId,"Payment Recieved ".$resultdesc,$mpesacost,$mpesareciept,$mpesadate, $mpesanumber);
